...
* [VS Code](https://code.visualstudio.com). Se debe instalar el plugin (devcontainers)[https://marketplace.visualstudio.com/items?itemName=ms-vscode-remote.remote-containers].
